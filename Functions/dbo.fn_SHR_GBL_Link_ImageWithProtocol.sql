...
CREATE FUNCTION [dbo].[fn_SHR_GBL_Link_ImageWithProtocol](@ImgURL [varchar](200), @ImgLink [varchar](200), @ImgClass [varchar](50), @ImgURLProtocol varchar(8), @ImgLinkProtocol varchar(8))
